...
export class CToken extends ethereum.SmartContract {
  ...
  try_accrualBlockTimestamp(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "accrualBlockTimestamp",
      "accrualBlockTimestamp():(uint256)",
      []
  ...
  try_borrowRatePerTimestamp(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "borrowRatePerTimestamp",
      "borrowRatePerTimestamp():(uint256)",
      []
  ...
  isQiToken(): boolean {
    let result = super.call("isQiToken", "isQiToken():(bool)", []);

    return result[0].toBoolean();
  }

  try_isQiToken(): ethereum.CallResult<boolean> {
    let result = super.tryCall("isQiToken", "isQiToken():(bool)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  try_supplyRatePerTimestamp(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "supplyRatePerTimestamp",
      "supplyRatePerTimestamp():(uint256)",
      []
